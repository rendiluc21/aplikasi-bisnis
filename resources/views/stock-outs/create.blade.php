...
@section('content')
    <div class="page-header">
        ...
        <a href="{{ route('stock-outs.index') }}" class="btn btn-primary">← Kembali</a>
    </div>
        ...
        <form action="{{ route('stock-outs.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <small style="color: #7f8c8d;">Pastikan jumlah tidak melebihi stok yang tersedia</small>
                </div>
                <div class="form-group">
            ...
            <div style="display: flex; gap: 0.75rem;">
                ...
                <a href="{{ route('stock-outs.index') }}" class="btn btn-primary btn-lg">Batal</a>
            </div>
        </form>
    </div>
@endsection
